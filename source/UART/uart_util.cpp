...
void sendSerial(void) {
	...
	snprintf(messageWithoutChecksum, sizeof(messageWithoutChecksum), "$PVCC,%d,%d,%d,%d,%d,%d,%d,%d", m_SYSTEMOPTIONS_DB[5].status ? 0 : 1, autocal_cmd, set1_set2_mode, position_capture_request, 0, 0, 0, 0);
